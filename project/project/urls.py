...
from blog.views import  HomeView, interface, modifier_transaction
from blog.views import dashboard, transactionView
from django.urls import path
from dashapp.views import login_page, dash_view, dash_view_rules, add_row, modify_row, dashboard_view, add_row_rule, modify_row_rule, dashboard_view_rule
